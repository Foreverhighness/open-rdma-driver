...
use crate::third_party::queues::command_request::descriptor::CmdQueueDescCommonHead;
...
pub(super) type Opcode = crate::third_party::queues::command_request::CtrlRbDescOpcode;
