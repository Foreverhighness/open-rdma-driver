...
use super::packet::{AETH, BTH, Immediate, PacketError, RDMA_PAYLOAD_ALIGNMENT, RETH};
use crate::third_party::queues::meta_report::{
    ToHostWorkRbDescAethCode, ToHostWorkRbDescOpcode, ToHostWorkRbDescTransType,
};
use crate::third_party::queues::send::{DescSge, ToCardWorkRbDesc, ToCardWorkRbDescCommon, ToCardWorkRbDescOpcode};
// use crate::device::{
...
// };
use crate::third_party::rdma::{MemAccessTypeFlag, Psn, QpType};
...
impl From<crate::third_party::rdma::Key> for Key {
    fn from(key: crate::third_party::rdma::Key) -> Self {
        Key::new(key.get())
    }
}

impl From<Key> for crate::third_party::rdma::Key {
...
impl SGList {
    ...
    pub(crate) fn into_four_sges(self) -> (DescSge, Option<DescSge>, Option<DescSge>, Option<DescSge>) {
        use crate::third_party::queues::send::DescSge;
        use crate::third_party::rdma::Key;
...
impl<T> From<std::sync::PoisonError<T>> for BlueRdmaLogicError {
