...
mod tests {
    ...
    fn test_client() {
        ...
        case!(client, 0, core::array::from_fn::<u8, 66, _>(|_| rng.r#gen()), [u8; 66]);
        case!(client, 20, core::array::from_fn::<u8, 20, _>(|_| rng.r#gen()), [u8; 20]);
        case!(
            client,
            0,
    ...
    fn test_client_u64() {
        ...
        case!(
            client,
            0,
            core::array::from_fn::<u64, 66, _>(|_| rng.r#gen()),
            [u64; 66]
        );
        case!(
            client,
            32,
            core::array::from_fn::<u64, 20, _>(|_| rng.r#gen()),
            [u64; 20]
        );
    }
}
